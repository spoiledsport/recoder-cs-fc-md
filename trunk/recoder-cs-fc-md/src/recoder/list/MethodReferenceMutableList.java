...
/**
  A mutable list for objects of type MethodReference.
 */

public interface MethodReferenceMutableList extends MethodReferenceList {
    ...
    */
    void set(int index, MethodReference element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, MethodReference element);
