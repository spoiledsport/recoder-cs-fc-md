...
/**
  A mutable list for objects of type FieldReference.
 */
...
public interface FieldReferenceMutableList extends FieldReferenceList {
    ...
    */
    void set(int index, FieldReference element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, FieldReference element);
