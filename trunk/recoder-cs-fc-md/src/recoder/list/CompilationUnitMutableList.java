...
/**
  A mutable list for objects of type CompilationUnit.
 */

public interface CompilationUnitMutableList extends CompilationUnitList {
    ...
    */
    void set(int index, CompilationUnit element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, CompilationUnit element);
