...
/**
  A mutable list for objects of type Statement.
 */

public interface StatementMutableList extends StatementList {
    ...
    */
    void set(int index, Statement element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, Statement element);
