...
/**
  A mutable list for objects of type NamespaceReference.
 */

public interface NamespaceReferenceMutableList extends NamespaceReferenceList {
    ...
    */
    void set(int index, NamespaceReference element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, NamespaceReference element);
