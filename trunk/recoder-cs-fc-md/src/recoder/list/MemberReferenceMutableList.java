...
/**
  A mutable list for objects of type MemberReference.
 */

public interface MemberReferenceMutableList extends MemberReferenceList {
    ...
    */
    void set(int index, MemberReference element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, MemberReference element);
