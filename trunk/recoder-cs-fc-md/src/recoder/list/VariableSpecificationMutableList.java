...
/**
  A mutable list for objects of type VariableSpecification.
 */
...
public interface VariableSpecificationMutableList extends VariableSpecificationList {
    ...
    */
    void set(int index, VariableSpecification element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, VariableSpecification element);
