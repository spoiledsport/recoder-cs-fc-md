...
/**
  A mutable list for objects of type ProgramModelElement.
 */

public interface ProgramModelElementMutableList extends ProgramModelElementList {
    ...
    */
    void set(int index, ProgramModelElement element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, ProgramModelElement element);
