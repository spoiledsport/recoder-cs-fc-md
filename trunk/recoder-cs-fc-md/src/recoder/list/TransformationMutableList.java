...
/**
  A mutable list for objects of type Transformation.
 */
...
public interface TransformationMutableList extends TransformationList {
    ...
    */
    void set(int index, Transformation element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, Transformation element);
