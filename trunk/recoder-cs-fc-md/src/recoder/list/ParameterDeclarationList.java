...
/**
  A list for objects of type ParameterDeclaration. This interface does not define
  mutators and is extended by ParameterDeclarationMutableList.
  @see ParameterDeclarationMutableList  
*/
public interface ParameterDeclarationList extends ProgramElementList, ModelElementList, ObjectList {
     ...
     * An empty list.
     */
    ParameterDeclarationList EMPTY_LIST = new ParameterDeclarationArrayList();
     ...
     * index &gt;= size()
     */
    ParameterDeclaration getParameterDeclaration(int index);
