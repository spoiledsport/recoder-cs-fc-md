...
import recoder.csharp.LoopInitializer;
// This file is part of the RECODER library and protected by the LGPL.

/**
  A list for objects of type LoopInitializer. This interface does not define
  mutators and is extended by LoopInitializerMutableList.
  @see LoopInitializerMutableList  
*/
public interface LoopInitializerList extends ProgramElementList, ModelElementList, ObjectList {
     ...
     * An empty list.
     */
    LoopInitializerList EMPTY_LIST = new LoopInitializerArrayList();
     ...
     * index &gt;= size()
     */
    LoopInitializer getLoopInitializer(int index);
