...
/**
  A mutable list for objects of type VariableReference.
 */

public interface VariableReferenceMutableList extends VariableReferenceList {
    ...
    */
    void set(int index, VariableReference element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, VariableReference element);
