...
public interface UsingMutableList extends UsingList {
    ...
    */
    void set(int index, Using element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, Using element);
