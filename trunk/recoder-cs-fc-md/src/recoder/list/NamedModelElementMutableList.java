...
/**
  A mutable list for objects of type NamedModelElement.
 */
...
public interface NamedModelElementMutableList extends NamedModelElementList {
    ...
    */
    void set(int index, NamedModelElement element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, NamedModelElement element);
