...
/**
  A mutable list for objects of type Branch.
 */

public interface BranchMutableList extends BranchList {
    ...
    */
    void set(int index, Branch element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, Branch element);
