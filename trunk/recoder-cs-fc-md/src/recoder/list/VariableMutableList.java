...
/**
  A mutable list for objects of type Variable.
 */
...
public interface VariableMutableList extends VariableList {
    ...
    */
    void set(int index, Variable element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, Variable element);
     ...
     */	
    void insert(int index, VariableList list);
