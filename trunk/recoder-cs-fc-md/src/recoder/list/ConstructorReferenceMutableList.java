...
/**
  A mutable list for objects of type ConstructorReference.
 */
...
public interface ConstructorReferenceMutableList extends ConstructorReferenceList {
    ...
    */
    void set(int index, ConstructorReference element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, ConstructorReference element);
