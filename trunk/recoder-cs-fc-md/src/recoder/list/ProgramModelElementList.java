...
/**
  A list for objects of type ProgramModelElement. This interface does not define
  mutators and is extended by ProgramModelElementMutableList.
  @see ProgramModelElementMutableList  
*/
public interface ProgramModelElementList extends NamedModelElementList, ModelElementList, ObjectList {
     ...
     * An empty list.
     */
    ProgramModelElementList EMPTY_LIST = new ProgramModelElementArrayList();
     ...
     * index &gt;= size()
     */
    ProgramModelElement getProgramModelElement(int index);
