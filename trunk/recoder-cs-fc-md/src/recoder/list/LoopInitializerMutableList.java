...
/**
  A mutable list for objects of type LoopInitializer.
 */
...
public interface LoopInitializerMutableList extends LoopInitializerList {
    ...
    */
    void set(int index, LoopInitializer element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, LoopInitializer element);
