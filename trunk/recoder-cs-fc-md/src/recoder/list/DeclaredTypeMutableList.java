...
/**
  A mutable list for objects of type DeclaredType.
 */

public interface DeclaredTypeMutableList extends DeclaredTypeList {
    ...
    */
    void set(int index, DeclaredType element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, DeclaredType element);
