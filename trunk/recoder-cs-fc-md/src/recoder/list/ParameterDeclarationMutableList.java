...
import recoder.csharp.declaration.ParameterDeclaration;
/**
  A mutable list for objects of type ParameterDeclaration.
 */

public interface ParameterDeclarationMutableList extends ParameterDeclarationList {
    ...
    */
    void set(int index, ParameterDeclaration element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, ParameterDeclaration element);
