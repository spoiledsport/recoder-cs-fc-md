...
/**
  A mutable list for objects of type Modifier.
 */
...
public interface ModifierMutableList extends ModifierList {
    ...
    */
    void set(int index, Modifier element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, Modifier element);
