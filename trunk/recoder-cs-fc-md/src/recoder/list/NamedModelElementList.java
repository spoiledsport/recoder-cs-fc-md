...
/**
  A list for objects of type NamedModelElement. This interface does not define
  mutators and is extended by NamedModelElementMutableList.
  @see NamedModelElementMutableList  
*/
public interface NamedModelElementList extends ModelElementList, ObjectList {
     ...
     * An empty list.
     */
    NamedModelElementList EMPTY_LIST = new NamedModelElementArrayList();
     ...
     * index &gt;= size()
     */
    NamedModelElement getNamedModelElement(int index);
