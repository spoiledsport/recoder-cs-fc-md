...
/**
  A mutable list for objects of type TreeChange.
 */
...
public interface TreeChangeMutableList extends TreeChangeList {
    ...
    */
    void set(int index, TreeChange element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, TreeChange element);
