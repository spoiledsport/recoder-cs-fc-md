...
/** this class represents a java style structured comment. Such a
    comment has an introductionary description and a list of tagged
    descriptions.
    @author Rainer Neumann
    @deprecated This class will be integrated into XmlDocComment.
*/
public class TaggedComment {
    ...
    /** the tags contained in the comment. This is required to obtain
	the order in which the tags occur
    */
    protected Vector tagNames;

    /** the tags and their string values. Tags are stored without the
        leading <tt>@</tt> sign
    */
    ...
    private static Enumeration emptyEnumeration = emptyVector.elements();

    /** creates a new instance from the given string. The given string
	<b>must not</b> be <tt>null</tt>!
    ...
    */
    ...
    /** strips comment characters from the beginning and end of the
	given string representing a single line.
	@param line the string representing the line. The line is
    ...
    */
    ...
    /** parses the raw comment string and computes the intro and tag
	values.
    */
    protected void parseRawComment() {
	LineNumberReader lnr =
	    new LineNumberReader(new StringReader(rawComment));
	boolean done = false;
    ...
    /** returns the introductionary text of the comment. This is the
	text starting at the beginning of the comment to the first
	tag.
    ...
    */
    ...
    /** determines whether or not there are tags contained in the
	underlying comment.
    ...
    */
    ...
    /** return an enumeration of tags contained in the comment in
	order of their apperance in the comment.
    ...
    */
    ...
    /** returns the text for the given tag or <tt>null</tt> if that
	tag is not defined.
