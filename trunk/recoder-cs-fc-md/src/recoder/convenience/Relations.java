...
public class Relations {
    ...
    /**
       ...
       {@link recoder.csharp.reference.UncollatedReferenceQualifier}s.
       <BR>
       In case of {@link recoder.csharp.Identifier} or 
       {@link recoder.csharp.expression.Literal}s, the textual representations
       are compared, while {@link recoder.csharp.declaration.Modifier} are
       compared by type only. 
       <BR>
       {@link recoder.csharp.NonTerminalProgramElement}s are compared 
       ...
       its name if it is a {@link recoder.csharp.NamedProgramElement} and
