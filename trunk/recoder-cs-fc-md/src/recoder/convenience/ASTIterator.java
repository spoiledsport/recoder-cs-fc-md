...
public class ASTIterator {
    ...
    /** Return value for ASTListener methods, that signals that no child
	node should be entered.
    */
    public static final int ENTER_NONE = 0;

    /** Return value for ASTListener methods, that signals that only some children
	nodes should be entered - each child will be queried separately.
    */
    ...
    */
	...
	This method calls the ASTIteratorListener methods.
    ...
    */
    ...
    /** Recurses through the given AST in depth first search order.
     * This method is only called if no iterator listener has been assigned.
     * The purpose of this method is to be specialized within subclasses:
     * <PRE>
     * protected void simpleRecurse(ProgramElement pe) {
     *    super.simpleRecurse(pe);
     *    dosomething(pe);
     * }
     * </PRE>
     * @param pe the current program element.
