...
/**
   Model change listener interface. All change history listeners
   are informed of changes of the syntactical program model.
   @author AL
   @since 0.5
*/
public interface ModelUpdateListener {
    ...
    /**
       ...
       @param event an event object containing the change history
       service as source.
       @since 0.72
     */
