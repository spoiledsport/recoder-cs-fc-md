...
/** 
    This class implements a simple FIFO using a dynamically growing
    and shrinking array.
...
public class Queue {
    ...
    /** copies the data array to the given array. Data in the new array
	starts at position 0. It is assumed, that the new array has a
	suitable size.
