...
public interface AttributeSectionMutableList extends AttributeSectionList {
    ...
    */
    void set(int index, AttributeSection element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, AttributeSection element);
