...
/**
  A mutable list for objects of type DesignPattern.
 */

public interface AttributeArgumentMutableList extends AttributeArgumentList {
    ...
    */
    void set(int index, AttributeArgument element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, AttributeArgument element);
