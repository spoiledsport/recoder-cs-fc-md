...
public class UncheckedBlock extends CSharpStatement implements StatementContainer {
    ...
    public UncheckedBlock(StatementBlock body) {
        setBody(body);
        makeParentRoleValid();
    }
    ...
    public UncheckedBlock(Expression e, StatementBlock body) {
        setBody(body);
        makeParentRoleValid();
    }
    ...
    protected UncheckedBlock(UncheckedBlock proto) {
        super(proto);
        if (proto.body != null) {
    ...
    public Object deepClone() {
        return new UncheckedBlock(this);
    }
