...
/**
   ...
   Scopes should not be accessed from outside the SourceInfo service.
 */
...
public interface ScopeDefiningElement extends NonTerminalProgramElement {
    ...
    */
    ...
    /**
       ...
       If set to defined, the scope cache becomes initialized.
       If set to undefined, the scope cache becomes erased.
    */
