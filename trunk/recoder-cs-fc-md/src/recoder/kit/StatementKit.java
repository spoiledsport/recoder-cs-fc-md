...
public class StatementKit {
	...
	/**       
	   ...
	   given statement, and creating a new {@link recoder.csharp.StatementBlock}
	   if necessary.
	   ...
	   {@link recoder.csharp.StatementBlock}.
	...
	*/
	...
	/**
	   ...
	   list, this list is returned (e.g. {@link recoder.csharp.statement.Case}).
	   </LI>
	   <LI>If the statement container is a {@link recoder.csharp.StatementBlock},
	   its list is returned (except it is empty).
	   </LI>
	   <LI>If the statement is the body of a
	   {@link recoder.csharp.statement.LabeledStatement}, the list for
	...
	*/
	...
	/**
	   ...
	   {@link recoder.csharp.declaration.LocalVariableDeclaration} containing
