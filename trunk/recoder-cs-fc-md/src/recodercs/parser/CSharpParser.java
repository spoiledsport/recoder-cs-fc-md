...
import recodercs.parser.ParseException;
  ...
  Expression expr;
    if (jj_2_31(2)) {
      ...
      try {
          ...
          {if (true) throw new ParseException("Class cast error: ExpressionStatement expected - found " + recodercs.convenience.Format.toString("%c @%p %s", expr));}
      }
        break;
      case SWITCH:
