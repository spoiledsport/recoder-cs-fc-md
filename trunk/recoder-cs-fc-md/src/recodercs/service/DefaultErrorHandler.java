...
public class DefaultErrorHandler implements ErrorHandler {
	...
	/**
	   ...
	   refers to unavailable code. This suppresses corresponding
	...
	/**
	   Redefine this method to indicate that the specified element
	   belongs to a code template. This suppresses corresponding
	   unresolved reference errors.
	   The default implementation returns <CODE>false</CODE>.
	 */
	...
	/**
	   ...
	   {@link recodercs.service.UnresolvedReferenceException}s and
	   returns <CODE>true</CODE> if the cause is either
	   part of an incomplete model or contained in template code.
	...
	/**
	   ...
	   but the system will continue to find further errors.
	   The default implementation writes a note to stderr.
	 */
	...
	/**
	   ...
	   finished and there were non-ignorable errors.
	   The default implementation writes a message to stderr and throws
	   a model exception.
	 */
