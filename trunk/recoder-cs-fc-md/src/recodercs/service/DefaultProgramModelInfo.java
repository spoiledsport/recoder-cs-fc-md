...
import recodercs.abstraction.NullType;
...
import recodercs.service.ClassTypeTopSort;
import recodercs.service.CyclicInheritanceException;
import recodercs.service.DefaultProgramModelInfo;
import recodercs.service.ErrorHandler;
import recodercs.service.NameInfo;
import recodercs.service.ProgramModelInfo;
//import recodercs.service.SubTypeTopSort;
//import recodercs.service.SuperTypeTopSort;
...
public abstract class DefaultProgramModelInfo
	...
	*/
	...
	/** @see recodercs.service.ProgramModelInfo#getSubtypes(ClassType)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#getAllSubtypes(ClassType)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#getAllSupertypes(ClassType)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#getAllFields(ClassType)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#getAllMethods(ClassType)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#getPromotedType(PrimitiveType, PrimitiveType)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#isWidening(PrimitiveType, PrimitiveType)
	 */
...
//		return (from == ni.getByteType() && to == ni.getShortType());
	...
	/** @see recodercs.service.ProgramModelInfo#isWidening(ClassType, ClassType)
	 */
	public boolean isWidening(ClassType from, ClassType to) {
		return isSubtype(from, to);
	}

	/** @see recodercs.service.ProgramModelInfo#isWidening(ArrayType, ArrayType)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#isCompatibleSignature(TypeList, TypeList)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#isVisibleFor(Member, DeclaredType)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#filterApplicableMethods(MethodMutableList, String, TypeList, ClassType)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#filterMostSpecificMethods(MethodMutableList)
	 */
	...
	/** @see recodercs.service.ProgramModelInfo#getMethods(ClassType)
	 */
