...
/**
   ...
   @author AL
 */
public class DelegateConstructor implements Constructor {

	protected ProgramModelInfo service;

	protected Delegate ownerDelegate;

	/**
	   Create a new default constructor for the given class type.
	   The name of the constructor is set appropriately.
	   @param ownerDelegate the owner class of this constructor.
	 */
	public DelegateConstructor(Delegate ownerDelegate) {
		Debug.asserta(ownerDelegate);
