...
/**
 Outer or inner class declaration.
 ...
 <ul>
 <li>getClassContainer() instanceof Namespace
 <li>getStatementContainer() == null
 <li>getName() != null
 </ul>
 <li>member classes
 ...
 */
public class ClassDeclaration extends ClassTypeDeclaration implements Statement {
    ...
    public ClassDeclaration(ModifierMutableList modifiers, Identifier name, Extends extended, Implements implemented, MemberDeclarationMutableList members) {
     ...
     */
    public ClassDeclaration(MemberDeclarationMutableList members) {
        setMembers(members);
        makeParentRoleValid();
    }
    ...
    */
    ...
    public StatementContainer getStatementContainer() {
        return (parent instanceof StatementContainer) ?
            (StatementContainer)parent : null;
    }

    /**
     Set statement container. Must be a {@link recodercs.csharp.StatementBlock}.
