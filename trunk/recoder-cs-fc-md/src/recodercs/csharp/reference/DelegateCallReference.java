...
public class DelegateCallReference
...
// Already defined in VariableReference
//	/**
//	 Name.
//	 */
//
//	protected Identifier name;
	...
	public DelegateCallReference(Identifier name) {
		setIdentifier(name);
		makeParentRoleValid();
	}
	...
	public DelegateCallReference(ReferencePrefix accessPath, Identifier name) {
	...
	public DelegateCallReference(Identifier name, ExpressionMutableList args) {
		setIdentifier(name);
		setArguments(args);
		makeParentRoleValid();
	}
	...
	protected DelegateCallReference(DelegateCallReference proto) {
		super(proto);
	...
	public Object deepClone() {
		return new DelegateCallReference(this);
	}
...
//	}
	...
	public void accept(SourceVisitor v) {
		v.visitDelegateCallReference(this);
	}
}
