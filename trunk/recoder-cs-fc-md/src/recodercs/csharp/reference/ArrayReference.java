...
public class ArrayReference extends CSharpNonTerminalProgramElement
 implements Reference, Expression, ReferencePrefix, ReferenceSuffix,
    ExpressionContainer, TypeReferenceContainer {

    /**
     Access parent when used as a reference prefix
     (e.g. <CODE>a[5].clone()</CODE>).
     */
    ...
    /**
     Inits.
     */
    protected ExpressionMutableList inits;
    ...
    public ArrayReference(ReferencePrefix accessPath, ExpressionMutableList initializers) {
    ...
    protected ArrayReference(ArrayReference proto) {
        ...
        if (proto.inits != null) {
            inits = (ExpressionMutableList)proto.inits.deepClone();
        }
        makeParentRoleValid();
    }
    ...
    public void makeParentRoleValid() {
        ...
        if (inits != null) {
            for (int i = inits.size() - 1; i >= 0; i -= 1) {
                inits.getExpression(i).setExpressionContainer(this);
            }
        }
    }
    ...
    */
    ...
    public ExpressionMutableList getDimensionExpressions() {
        return inits;
    }
    ...
    public void setDimensionExpressions(ExpressionMutableList list) {
        inits = list;
    }
