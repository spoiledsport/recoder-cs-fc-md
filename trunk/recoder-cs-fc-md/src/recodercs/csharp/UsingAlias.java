...
public class UsingAlias extends Using
 implements TypeReferenceContainer, NamespaceReferenceContainer, 
    ...
    public UsingAlias(TypeReference t, boolean multi) {
        setReference(t);
     ...
     */
    public UsingAlias(NamespaceReference t) {
        setReference(t);
        setMultiImport(true);
    }
     ...
     */
    protected UsingAlias(UsingAlias proto) {
        super(proto);
    ...
    */
	...
	/** Identifier for the aliased namespace or type. */
