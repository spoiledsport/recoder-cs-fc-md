...
import recodercs.list.ModelElementList;
...
*/
public interface AttributeSectionList extends ProgramElementList, ObjectList {

    /**
     * An empty list.
     */
    AttributeSectionList EMPTY_LIST = (AttributeSectionList) new AttributeSectionArrayList();
     ...
     * index &gt;= size()
     */
    AttributeSection getAttributeSection(int index);
    ...
    /**
       ...
       @since 0.71
     */
    AttributeSection[] toAttributeSectionArray();
