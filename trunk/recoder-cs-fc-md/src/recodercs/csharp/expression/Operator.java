...
public abstract class Operator extends CSharpNonTerminalProgramElement
    ...
    */
    ...
    public boolean isToBeParenthesized() {
        ...
        /* ReferencePrefices include ParenthesizedExpressions, New, NewArray;
	   these all come with parentheses. */());
    }
