...
public class Catch extends Branch implements ParameterContainer,
                                             VariableScope {
    ...
    protected Catch(Catch proto) {
        ...
        if (proto.parameter != null) {
            parameter = (ParameterDeclaration)proto.parameter.deepClone();
        }
        if (proto.body != null) {
    ...
    */
    ...
    public VariableSpecification getVariableInScope(String name) {
        ...
        if (parameter != null) {
            ...
            if (v != null && v.getName() != null && name.equals(v.getName())) {
                return v;
            }
        }
        return null;
