...
import recodercs.csharp.declaration.LocalVariableDeclaration;
...
public class UsingBlock extends CSharpStatement implements StatementContainer, ExpressionContainer {

    /**
     * Local Variable Declaration
     */
    private LocalVariableDeclaration variable;
    ...
    public UsingBlock(Statement body) {
        setBody(body);
        makeParentRoleValid();
    }
    ...
    public UsingBlock(Expression e, Statement body) {
        setExpression(e);
        setBody(body);
        makeParentRoleValid();
    }
    ...
    protected UsingBlock(UsingBlock proto) {
        super(proto);
    ...
    */
    ...
    public int getChildPositionCode(ProgramElement child) {
        // role 0: expression
        // role 1: body
		// role 2: local variable declaration
        if (expression == child) {
            return 0;
        }
        if (body == child) {
    ...
    */
	 ...
	 */
	public void setLocalVariableDeclaration(LocalVariableDeclaration variable) {
