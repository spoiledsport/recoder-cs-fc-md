...
import recodercs.csharp.attributes.Attribute;
import recodercs.csharp.attributes.AttributeArgument;
import recodercs.csharp.attributes.AttributeSection;
import recodercs.csharp.attributes.AttributeTarget;
import recodercs.csharp.attributes.NamedAttributeArgument;
import recodercs.csharp.attributes.targets.AssemblyTarget;
import recodercs.csharp.attributes.targets.EventTarget;
import recodercs.csharp.attributes.targets.FieldTarget;
import recodercs.csharp.attributes.targets.MethodTarget;
import recodercs.csharp.attributes.targets.ModuleTarget;
import recodercs.csharp.attributes.targets.ParamTarget;
import recodercs.csharp.attributes.targets.PropertyTarget;
import recodercs.csharp.attributes.targets.ReturnTarget;
import recodercs.csharp.attributes.targets.TypeTarget;
...
import recodercs.io.PropertyNames;
import recodercs.list.*;
import recodercs.util.Debug;
import recodercs.util.StringUtils;
...
/**
   ...
   {@link recodercs.ProgramFactory#getPrettyPrinter}.
...
public class PrettyPrinter extends SourceVisitor implements PropertyNames {
	...
	*/
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitMethodGroupReference(MethodGroupReference)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitAddAccessor(AddAccessor)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitAs(As)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitAssemblyTarget(AssemblyTarget)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitAttribute(Attribute)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitAttributeSection(AttributeSection)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitChecked(Checked)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitCheckedBlock(CheckedBlock)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitDestructorDeclaration(DestructorDeclaration)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitDocComment(XmlDocComment)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitEventDeclaration(EventDeclaration)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitExtern(Extern)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitFieldSpecification(FieldSpecification)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitGetAccessor(GetAccessor)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitGoto(Goto)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitIndexerDeclaration(IndexerDeclaration)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitLiteral(Literal)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitMemberName(MemberName)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitModifier(Modifier)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitOperator(Operator)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitOperatorDeclaration(OperatorDeclaration)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitOut(Out)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitOutOperator(OutOperator)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitOverride(Override)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitParams(Params)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitPreDefinedTypeLiteral(PreDefinedTypeLiteral)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitPropertyDeclaration(PropertyDeclaration)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitReadonly(Readonly)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitRefOperator(RefOperator)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitRemoveAccessor(RemoveAccessor)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitSetAccessor(SetAccessor)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitTypeof(Typeof)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitUnchecked(Unchecked)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitUncheckedBlock(UncheckedBlock)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitUsingBlock(UsingBlock)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitVirtual(Virtual)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitStaticConstructorDeclaration(StaticConstructorDeclaration)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitAttributeArgument(AttributeArgument)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitEventTarget(EventTarget)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitFieldTarget(FieldTarget)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitInternal(Internal)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitMethodTarget(MethodTarget)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitModuleTarget(ModuleTarget)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitNamedAttributeArgument(NamedAttributeArgument)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitNewModifier(NewModifier)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitParamTarget(ParamTarget)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitPropertyTarget(PropertyTarget)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitReturnTarget(ReturnTarget)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitTypeTarget(TypeTarget)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitUsingAlias(UsingAlias)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitForeach(Foreach)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitConstantFieldDeclaration(ConstantFieldDeclaration)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitLocalConstantDeclaration(LocalConstantDeclaration)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitParameterDeclaration(ParameterDeclaration)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitConstructorDeclaration(ConstructorDeclaration)
	 */
	public void visitConstructorDeclaration(ConstructorDeclaration x) {
		printHeader(x);
		printElementIndentation(x);
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitEventSpecification(EventSpecification)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitDelegateCallReference(DelegateCallReference)
	 */
	...
	/**
	 * @see recodercs.csharp.SourceVisitor#visitUncollatedMethodCallReference(UncollatedMethodCallReference)
	 */
