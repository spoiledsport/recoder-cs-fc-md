...
/**
  A mutable list for objects of type ModelElement.
 */

public interface ModelElementMutableList extends ModelElementList {
    ...
    */
    void set(int index, ModelElement element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, ModelElement element);
     ...
     */	
    void insert(int index, ModelElementList list);
     ...
     */
    void add(ModelElementList list);
