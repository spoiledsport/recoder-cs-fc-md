...
/**
  A mutable list for objects of type MemberDeclaration.
 */

public interface MemberDeclarationMutableList extends MemberDeclarationList {
    ...
    */
    void set(int index, MemberDeclaration element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, MemberDeclaration element);
