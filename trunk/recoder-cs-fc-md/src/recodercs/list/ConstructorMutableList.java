...
/**
  A mutable list for objects of type Constructor.
 */
...
public interface ConstructorMutableList extends ConstructorList {
    ...
    */
    void set(int index, Constructor element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, Constructor element);
