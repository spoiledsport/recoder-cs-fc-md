...
/**
  A mutable list for objects of type Namespace.
 */

public interface NamespaceMutableList extends NamespaceList {
    ...
    */
    void set(int index, Namespace element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, Namespace element);
