...
/**
  A mutable list for objects of type TypeReference.
 */
...
public interface TypeReferenceMutableList extends TypeReferenceList {
    ...
    */
    void set(int index, TypeReference element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, TypeReference element);
