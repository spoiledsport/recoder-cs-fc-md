...
import recodercs.csharp.Comment;
/**
  A mutable list for objects of type Comment.
 */

public interface CommentMutableList extends CommentList {
    ...
    */
    void set(int index, Comment element);
    ...
    */
     ...
     */	
    void insert(int index, CommentList list);
