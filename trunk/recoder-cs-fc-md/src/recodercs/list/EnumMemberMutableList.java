...
/**
  A mutable list for objects of type EnumMember.
 */

public interface EnumMemberMutableList extends EnumMemberList {
    ...
    */
    void set(int index, EnumMember element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, EnumMember element);
