...
/**
  A mutable list for objects of type Using.
 */

public interface NamespaceSpecificationMutableList extends NamespaceSpecificationList {
    ...
    */
    void set(int index, NamespaceSpecification element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, NamespaceSpecification element);
