...
/**
   List implementation based on the doubling array technique for Variable
...
public class VariableArrayList
  ...
  implements VariableMutableList {
    ...
    */
    ...
    /**
       ...
       @since 0.01
    */
    public VariableArrayList(int initialCapacity) {
    ...
    /**
       ...
       @since 0.01
    */
    public VariableArrayList(Variable[] a) {
	super(a);
    }
    ...
    */
    protected VariableArrayList(VariableArrayList proto) {
	super(proto);
    }
    ...
    public final void set(int index, Variable element) {
	super.set(index, element);
    }

    public final void insert(int index, Variable element) {
	super.insert(index, element);
    }

    public final void insert(int index, VariableList list) {
	super.insert(index, list);
    }

    public final void add(Variable element) {
	super.add(element);
    }

    public final void add(VariableList list) {
	super.add(list);
    }    

    public final Variable getVariable(int index) {
	return (Variable)super.get(index);
    }
