...
/**
  A mutable list for objects of type TypeDeclaration.
 */

public interface TypeDeclarationMutableList extends TypeDeclarationList {
    ...
    */
    void set(int index, TypeDeclaration element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, TypeDeclaration element);
