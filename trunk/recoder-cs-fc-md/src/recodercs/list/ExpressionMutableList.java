...
/**
  A mutable list for objects of type Expression.
 */
...
public interface ExpressionMutableList extends ExpressionList {
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, Expression element);
     ...
     */	
    void insert(int index, ExpressionList list);
