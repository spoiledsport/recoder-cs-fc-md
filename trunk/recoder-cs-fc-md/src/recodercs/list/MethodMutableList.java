...
/**
  A mutable list for objects of type Method.
 */
...
public interface MethodMutableList extends MethodList {
    ...
    */
    void set(int index, Method element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, Method element);
