...
/**
  A mutable list for objects of type MethodDeclaration.
 */

public interface MethodDeclarationMutableList extends MethodDeclarationList {
    ...
    */
    void set(int index, MethodDeclaration element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, MethodDeclaration element);
