...
import recodercs.csharp.reference.UncollatedReferenceQualifier;
/**
  A mutable list for objects of type UncollatedReferenceQualifier.
 */

public interface UncollatedReferenceQualifierMutableList extends UncollatedReferenceQualifierList {
    ...
    */
    void set(int index, UncollatedReferenceQualifier element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, UncollatedReferenceQualifier element);
