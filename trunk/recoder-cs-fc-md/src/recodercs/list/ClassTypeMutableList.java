...
/**
  A mutable list for objects of type ClassType.
 */

public interface ClassTypeMutableList extends ClassTypeList {
    ...
    */
    void set(int index, ClassType element);
    ...
    */
    ...
    /**
      ...
      @exception IndexOutOfBoundsException if index < 0 or index > size()
     */	
    void insert(int index, ClassType element);
